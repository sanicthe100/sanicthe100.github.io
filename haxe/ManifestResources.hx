...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		library = AssetLibrary.fromManifest (manifest);
		Assets.registerLibrary ("week1", library);
...
@:keep @:file("") @:noCompletion #if display private #end class __ASSET__manifest_week1_json extends haxe.io.Bytes {}
